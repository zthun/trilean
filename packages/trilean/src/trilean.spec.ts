...
describe("ZTrilean", () => {
  describe("stringify", () => {
    ...
    it("should return indeterminate for indeterminate", () => {
      expect(ZTrilean.stringify(ZTrilean.Indeterminate)).toEqual(
        "indeterminate",
      );
    });
  });
  ...
  describe("parse", () => {
    ...
    it("should return null for indeterminate", () => {
      expect(ZTrilean.parse("indeTermiNate", true)).toEqual(
        ZTrilean.Indeterminate,
      );
    });
    ...
    it("should return fallback for undefined", () => {
      expect(ZTrilean.parse(undefined, ZTrilean.Indeterminate)).toEqual(
        ZTrilean.Indeterminate,
      );
    });
  ...
  describe("convert", () => {
    ...
    it("should be indeterminate for indeterminate", () => {
      expect(ZTrilean.convert(ZTrilean.Indeterminate)).toEqual(
        ZTrilean.Indeterminate,
      );
    });
